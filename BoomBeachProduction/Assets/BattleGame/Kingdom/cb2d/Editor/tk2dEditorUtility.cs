...
public static class tk2dEditorUtility
{
	...
	{
		EditorUtility.DisplayDialog("About CB 2D",
		                            "CB 2D Version " + ReleaseStringIdentifier(version, releaseId, buildNo) + "\n",
		                            "Ok");
	}
	
	[MenuItem(tk2dMenu.root + "Support/Website", false, 10103)]
	public static void LaunchForum()
	{
		Application.OpenURL("https://recinfotech.com");
	}
	...
	{
		EditorWindow.GetWindow( typeof(tk2dPreferencesEditor), true, "CB 2D Preferences" );
	}	
