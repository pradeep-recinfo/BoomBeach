...
public class MenuUnitBase : MonoBehaviour {
	...
	public int[] 
		trainingTimes,				//time to finish training for each unit- values are loaded from XML
		sizePerUnit,				//the unit+support personnel; number of soldiers != population
		trainingIndexes;			//how many units are under construction - from 0 to 10 maximum; temporary array 
			  
	public List<Vector4> queList = new List<Vector4>();		// qIndex, objIndex, trainingIndex
